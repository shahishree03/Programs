...
int main() {
   ...
   start = clock();//0
    ...
    cout << "Selection Sort Time: " << selectionSortTime << " seconds" << endl;//O(n^2)
        cout << "Merge Sort Time: " << mergeSortTime << " seconds" << endl;//O(nlogn)
     cout << "Bubble Sort Time: " << bubbleSortTime << " seconds" << endl;//(on^2)
